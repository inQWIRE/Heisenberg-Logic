...
Proof.
  intros Hc HQ.
  eapply SIMPLIFY_CPRED_PRE_RULE; [apply Hc|].
  now apply KILL_FALSE_RULE.
Qed.
...
Ltac kill_f :=
  try (eapply KILL_FALSE_RULE_EQUIV; [bsolve_btauto|first [intro; discriminate|shelve]]).
...
Ltac msolves := repeat (msolve; elim_falses).
